...
/* FAST GPIO */
#define GPIO0_DIR       (*(REG32 (0x3FFFC000)))
#define GPIO0_MASK      (*(REG32 (0x3FFFC010)))
#define GPIO0_READ      (*(REG32 (0x3FFFC014)))
#define GPIO0_SET       (*(REG32 (0x3FFFC018)))
#define GPIO0_CLEAR     (*(REG32 (0x3FFFC01C)))
...
/*##############################################################################
## MAM - Memory Accelerator Module - ext mthomas
##############################################################################*/
